...
flags.DEFINE_string('input_type', 'image_tensor', 'Type of input node. Can be '
                    ...
                    '`tf_example`]')
flags.DEFINE_string('pipeline_config_path', 'samples/configs/ssd_mobilenet_v1_pets.config',
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('checkpoint_path', 'model.ckpt-50000', 'Optional path to checkpoint file. '
                    'If provided, bakes the weights from the checkpoint into '
                    'the graph.')
flags.DEFINE_string('inference_graph_path', 'my_graph.pb ', 'Path to write the output '
                    'inference graph.')
